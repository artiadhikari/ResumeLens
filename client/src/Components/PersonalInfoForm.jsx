import { User, Mail, Phone, MapPin, BriefcaseBusiness, Globe, Link } from 'lucide-react'
...
onChange({...data, [field]:value})
  ...
  <div className='flex items-center gap-2'>
    <label>
      {data.image ? (
        <img src={typeof data.image === 'string' ? data.image : (data.image instanceof Blob ? URL.createObjectURL(data.image) : (data.image?.src || ''))} alt="user-image" className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opacity-80'/>
      ) : (
